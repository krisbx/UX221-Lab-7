...
<div class="notice notice-info is-dismissible <?php echo esc_attr($notice['unique_id']); ?>">
    <span class="st-sa-notification-wrapper">
        <span class="st-sa-notification-wrapper-info"><?php echo esc_html(sprintf(/* translators: %s is the theme name */__("Thank you for choosing %s", 'minimalistix'), $theme_name)); ?></span>
        <span class="st-sa-notification-wrapper-headline"><?php echo esc_html(sprintf(/* translators: %s is the theme name */__("Get Started with %s", 'minimalistix'), $theme_name)); ?></span>
        <span class="st-sa-notification-wrapper-paragraph"><?php echo esc_html(sprintf(/* translators: %s is the theme name */__("Install the %s companion plugin to unlock all theme features. This quick and free installation takes a few seconds and requires just one click.", 'minimalistix'), $theme_name)); ?>
            <span class="st-sa-notification-buttons-wrapper">
                <a href="<?php echo esc_url($nonce_url); ?>" class="st-sa-notification-buttons-purple"><?php echo esc_html__("Install & Activate", 'minimalistix'); ?></a>
            </span>
        </span>
        <style>
